...
public class BoardComponent extends JComponent {
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            for (GameListener listener : listenerList) {
                if(e.getX()<row*gridSize&&e.getY()<col*gridSize) listener.onPlayerLeftClick(location, (SquareComponent) clickedComponent);
            }
            ...
            BoardLocation location = getLocationByPosition(e.getX(), e.getY());
            for (GameListener listener : listenerList) {
                if(e.getX()<row*gridSize&&e.getY()<col*gridSize)listener.onPlayerRightClick(location, (SquareComponent) clickedComponent);
            }
        }
    }
    ...
    public void newWindow(String content,String title){
